...
echo "=========================================="
echo "Starting Comprehensive SDD-LSKD Training"
echo "=========================================="
...
# 2. ResNet32x4 -> MobileNetV2 (Heterogeneous architectures)
echo "=== Experiment 2: ResNet32x4 -> MobileNetV2 (Heterogeneous) ==="
...
# 3. WideResNet-40-2 -> WideResNet-16-2 (WideResNet family)
echo "=== Experiment 3: WideResNet-40-2 -> WideResNet-16-2 ==="
run_full_training "configs/cifar100/sdd_lskd/wrn40_2_wrn_16_2.yaml" "[1]" "wrn40_2_wrn16_2_global" "Global LSKD baseline"
run_full_training "configs/cifar100/sdd_lskd/wrn40_2_wrn_16_2.yaml" "[1,2]" "wrn40_2_wrn16_2_twoscale" "Two-scale SDD-LSKD fusion"
run_full_training "configs/cifar100/sdd_lskd/wrn40_2_wrn_16_2.yaml" "[1,2,4]" "wrn40_2_wrn16_2_threescale" "Three-scale SDD-LSKD fusion"
...
echo "2. ResNet32x4 -> MobileNetV2 (M=[1], M=[1,2], M=[1,2,4])" >> "$SUMMARY_FILE"
echo "3. WideResNet-40-2 -> WideResNet-16-2 (M=[1], M=[1,2], M=[1,2,4])" >> "$SUMMARY_FILE"
echo "" >> "$SUMMARY_FILE"
...
echo ""
echo "=========================================="
echo "🎉 SDD-LSKD Training Session Completed! 🎉"
echo "=========================================="
